...
##Out-of-sample estimation and analysis

To obtain an out-of-sample estimation, we predict on our validation set. Almost 95% of the predictions are correct. A visualization of the confusion matrix gives more light to the strengths and 
